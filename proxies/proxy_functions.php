...
//widget header js
function fcchat_add_template_overrides(){
	global $fcchat_plugin_url;
	$fcchat_options=fcchat_get_widget_options();
	$header='';
        if ($fcchat_options['template_overrides']['value']!=""){
		$header= '(function(){function getObj(a,b,d){var c=window;for(var i=0;i<b.length-d;i++){c=c[b[i]]}return c};function setOption(a,d){try{var b=a.split(".");var c= getObj(a,b,1);c[b[b.length-1]]=d}catch(e){}};function mergeOption(a,d){try{var b=a.split(".");var c = getObj(a,b,1);c[b[b.length-1]]+=d}catch(e){}};function mergeBlock(a,d){try{var b=a.split(".");var c=getObj(a,b,0);jGo.$.extend(true,c,d)}catch(e){}};';
		...
		$header.= $fcchat_options['template_overrides']['value'];
		$header.= '})();';
        }
	return $header;
}
