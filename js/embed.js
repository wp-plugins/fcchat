document.write((FCChatConfig.styles.chat_toolbox.fixed&&!window['fc_pop_up']&&top==self?"<div id='fc_chat_floating_div' style='position: fixed; z-index: 2147480320;visibility: visible;" +
					"left:" + (FCChatConfig.styles.chat_toolbox.fixed_pos=="top-left"||FCChatConfig.styles.chat_toolbox.fixed_pos=="bottom-left"?"-1px;" : + jQuery(window).width()-(FCChatConfig.styles.chat_toolbox.width+26) + "px;") +
					"top:" + (FCChatConfig.styles.chat_toolbox.fixed_pos=="top-left"||FCChatConfig.styles.chat_toolbox.fixed_pos=="top-right"?"-1px;" : + jQuery(window).height()-FCChatConfig.styles.chat_toolbox.height + "px;") +
					"'>":"") +
