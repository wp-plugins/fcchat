...
(function(){
	...
	FCChatConfig.styles.widget={
		...
		online_box:{
			...
			greeting_box_css:"top:40px;left:0px;height:40px;background-color:#fefefe;border-top:1px solid #cccccc;border-bottom:1px dotted #444444;",
			...
			info_box_css:"top:273px;left:0px;height:70px;background-color:#fefefe;border-top:1px dotted #444444;",
		...
		new_messages_box:{
			...
			send_msg_box_css:"top:273px;left:0px;height:70px;background-color:#fefefe;border-top:1px dotted #444444;",
