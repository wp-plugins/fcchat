...
jGo.fcchat_toolbar.style={
		height:35,
		border_height:2,
		css:"-webkit-box-shadow:0px 0px 8px 2px rgba(0,0,0,0.4);box-shadow:0px 0px 8px 2px rgba(0,0,0,0.4);background-color:#eee;border-top: 2px solid #2E9FFF;border-bottom: 2px solid #2E9FFF;triangle-color:#2E9FFF;",
		banner_css:{"background-color":"#eee","border-bottom":"2px solid #2E9FFF","border-top":"2px solid #2E9FFF"},
		mobile_banner:{
			title:"color:green;",
		...
		dialog_box:{
			css:"-webkit-transform: translate3d(0,0,0);-webkit-box-shadow:0em 0em .5em .167em rgba(0,0,0,0.4);box-shadow:0em 0em .5em .167em rgba(0,0,0,0.4);background-color:#eee;",
