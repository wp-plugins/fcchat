...
jGo.fcchat_toolbar.chatbox.style={
	...
	dialog_box:{
		...
		userlist_box_css:"top:40px;left:0px;-moz-overflow-scrolling: touch;-webkit-overflow-scrolling: touch;overflow-scrolling: touch;height:40px;border-top:1px solid #cccccc;border-bottom:1px dotted #444444;",
		...
		view_msg_box_css:"width:"+(jGo.mobile?300:FCChatConfig.chatbox.dialog_width)+"px;-moz-overflow-scrolling: touch;-webkit-overflow-scrolling: touch;overflow-scrolling: touch;top:82px;left:0px;height:200px;padding-top:4px;",
...
(function () {
	...
	var render_dialog_content = function(){
		if(rendered==0){
			...
			"<div class='fc_d6' id='fc_page_chat_wrapper' style='position:absolute;" + config.dialog_box.view_msg_box_css + "overflow:auto'><div id='fc_page_chat' style='padding:3px;overflow:auto;line-height:1'>" +
			add_page_start()+
			"</div></div>" +
