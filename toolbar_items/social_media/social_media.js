...
(function () {
	...
	var create_menu_item = function(){
	  return"<div class='fc_share_button' style='position: absolute;width:"+config.menu_item.width+"px;top:"+ (jGo.fcchat_toolbar.style.icons_16px.top+fc_chat.get_ie_offset()) + "px; left: "+config.menu_item.button.left+"px;'>" +
