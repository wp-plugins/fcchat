...
function fcchat_widget_init() {
	  ...
	  //Echo widget to sidebar
		...
		//Upgrade notice 
		echo '<p style="text-align:left"><b>Upgrade notice:</b>Upgrading to version 2.2.2 from a version prior to 2.1.8 requires that you obtain a new chat ID from the link above.</p>';
