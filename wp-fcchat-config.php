...
function fcchat_widget_options() {
  	return array(
		...
		"cmntver"=>array("value"=>"","type"=>"comment","desc"=>"VERSION"),
		"jQuery_stable"=>array("value"=>"1.6.4","type"=>"text","quote"=>"1","sz"=>"20","desc"=>"Minimum version of JQuery."),
...
"current_domain"=>array("value"=>"fastcatsoftware.com","type"=>"text","quote"=>"1",sz=>"80","desc"=>"The curent domain."),
		...
		"max_video_streams"=>array("value"=>"30","type"=>"text","quote"=>"0",sz=>"20","desc"=>"The maximum number of video simultaneous video streams."),
		...
		"video_window1_color"=>array("value"=>"darkOliveGreen","type"=>"text","quote"=>"1",sz=>"50","desc"=>"Window color for the video pool window."),
		"video_window2_color"=>array("value"=>"darkOliveGreen","type"=>"text","quote"=>"1",sz=>"50","desc"=>"Window color for the single video expandable window."),
